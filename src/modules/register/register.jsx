                                        ...
                                        <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                            ...
                                            <form className="mx-1 mx-md-4">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    <i className="fas fa-envelope fa-lg me-3 fa-fw mr-1" />
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input type="email" id="form3Example3c" className="form-control" placeholder='Your Name' />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    <i className="fas fa-envelope fa-lg me-3 fa-fw mr-1" />
                                                    <div className="form-outline flex-fill mb-0">
                                                        <input type="email" id="form3Example3c" className="form-control" placeholder='Phone Number' />
                                                    </div>
                                                </div>
